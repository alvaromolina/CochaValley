...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "No coincide.",
		accept: "Ingrese un valor con la extension correcta.",
		...
		max: $.validator.format("Ingrese un valor igual o menor a {0}."),
		min: $.validator.format("Ingrese un valor igual o mayor a {0}.")
	}, 
	/*
	messages: {
